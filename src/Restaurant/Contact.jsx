    ...
    <div className="bg-slate-50 min-h-screen font-sans text-slate-800 antialiased overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 p-5 sm:p-6 space-y-4">
              ...
              <a
                href={`tel:${PHONE}`}
                className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 hover:bg-amber-50 border border-slate-200 hover:border-amber-300 transition-all duration-200 group"
              >
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center text-white text-xl flex-shrink-0">
                  📞
                </div>
                <div>
              ...
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 hover:bg-green-50 border border-slate-200 hover:border-green-300 transition-all duration-200 group"
              >
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center text-white text-xl flex-shrink-0">
                  💬
                </div>
                <div>
                  <p className="text-[11px] text-slate-500 font-medium">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 hover:bg-blue-50 border border-slate-200 hover:border-blue-300 transition-all duration-200 group"
              >
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-xl flex-shrink-0">
                  📍
                </div>
                <div>
                  <p className="text-[11px] text-slate-500 font-medium">
            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 p-5 sm:p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={s}
                    className="px-3 py-1.5 bg-amber-50 border border-amber-100 text-amber-700 text-xs font-semibold rounded-xl"
                  >
                    {s}
                  </span>
                ))}
              ...
              {submitted ? (
                ...
                <div className="text-center py-10 space-y-4">
                  ...
                  <button
                    ...
                    className="mt-2 px-6 py-3 bg-slate-900 hover:bg-amber-500 hover:text-slate-950 text-white font-semibold rounded-xl text-sm transition-all duration-200"
                  >
                    ახალი შეტყობინება
                  </button>
                </div>
                ...
                <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-5 gap-2">
                      {["1", "2", "3", "4", "5+"].map((n) => (
                        <button
                          ...
                          className={`py-3 rounded-xl text-sm font-bold border transition-all duration-200 active:scale-95 ${
                            form.guests === n
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 font-bold rounded-xl text-sm sm:text-base transition-all duration-200 active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20"
                  >
                    <span>💬</span>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="block w-full h-40 sm:h-52 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-slate-200 to-slate-300 border border-slate-200 overflow-hidden relative group hover:shadow-lg transition-all duration-300"
        >
